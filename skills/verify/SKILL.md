...
- Never mark a criterion VERIFIED without evidence. State the evidence tersely — the concrete check run and its result (test name and outcome, load-test numbers, the manual steps taken) — not a restatement of the criterion.
